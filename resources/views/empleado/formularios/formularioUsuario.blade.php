<div class="from-group">
	...
	{!! Form::number('Telefono') !!}
		{!!Form::label('Genero  ')!!}
		{!! Form::radio('genero', 'F') !!}{!!Form::label('Femenino')!!}{!! Form::radio('genero', 'M') !!}{!!Form::label('Masculino  ')!!}
...
// check if both select are valid
	...
	{!!Form::date('FechaDeNacimiento',\Carbon\Carbon::now()->subYears(18)->format('Y-m-d'), ['class'=>'form-control', 'placeholder'=>'Ingrese la Fecha Prevista de Devolucion', 'max'=>\Carbon\Carbon::now()->subYears(18)->format('Y-m-d'),'required'=>'required'])!!}


	{!!Form::label('Tipo Usuario')!!}
	{!! Form::select('idTipoUsuario', $tipo, null, ['class' => 'form-control']) !!}
